...
if __name__ == "__main__":
    ...
    layer_config = sys.argv[2]

    
    ndn = 4
    ndn2 = 4

    experiment_parametrization_A = {
        'dilation_rates_dn1': [4,8,16,32],
        'kernel_sizes_dn1' : [5,5,5,5],
        'nfilters_dn1' :  [20]*4,
        'dilation_rates_dn2' : [4]*4, #unused
        'kernel_sizes_dn2' : [5]*ndn2, #unused
        'nfilters_dn2': [10]*ndn2 #unused
    }

    experiment_parametrization_B = {
        'dilation_rates_dn1': [8,8,8,8],
        'kernel_sizes_dn1' : [5,5,5,5],
        'nfilters_dn1' :  [20]*4,
    ...
    experiment_parametrization_D = {
        'dilation_rates_dn1': [8,8,8,8],
        'kernel_sizes_dn1' : [10,10,10,10],
        'nfilters_dn1' :  [20]*ndn,
        'dilation_rates_dn2' : [4]*ndn2, #unused
        'kernel_sizes_dn2' : [5]*ndn2, #unused
        'nfilters_dn2': [10]*ndn2 #unused
    ...
    experiment_parametrization_F = {
        'dilation_rates_dn1': [4,4,4,4],
        'kernel_sizes_dn1' : [10,10,10,10],
        'nfilters_dn1' :  [20]*ndn,
        'dilation_rates_dn2' : [4]*ndn2, #unused
        'kernel_sizes_dn2' : [5]*ndn2, #unused
    ...
    experiment_parametrization_C = {
        'dilation_rates_dn1': [16,16,16,16],
        'kernel_sizes_dn1' : [5,5,5,5],
        'nfilters_dn1' :  [20]*ndn,
        'dilation_rates_dn2' : [4]*ndn2, #unused
        'kernel_sizes_dn2' : [5]*ndn2, #unused
    ...
    experiment_parametrization_dict = {"A":experiment_parametrization_A, "B":experiment_parametrization_B, "C":experiment_parametrization_C , "D" : experiment_parametrization_D , "F" : experiment_parametrization_F}
    experiment_parametrization = experiment_parametrization_dict[layer_config]
    ...
    for leave_exp_out in ["VA_1","VA_3"] : #["VA_1", "VA_2", "VA_3" , "VA_4"]:
        for seed in rseeds:
            ...
            results_dir_name = os.path.join("Experiments_C",desc_str);
            try:
            ...
            Xtrain, Xtest,Ytrain, Ytest, EIDTrain, EIDTest = train_test_split(X, Y_OH, EidOH,
                                                                              stratify = Y_classes,
                                                                              train_size = 0.80, random_state = seed)
            ...
            dict_to_df['seed'] = seed
            dict_to_df['top3_strong'] = top3_strong_list
            dict_to_df['experiment_parametrization'] = layer_config
